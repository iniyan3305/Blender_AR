...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: auto; background-color: rgba(255, 255, 255, 0); width: 200px; height: 50px; bottom: 20px; left: 50%; margin-left: -100px; background-size: 100%; cursor: pointer; outline: 0;", false, '');
...
setHTMLElemAttribute('href', 'https://iniyan3305.github.io/my3dprofile/', 'info_button', false);
...
operateAnimation('PLAY', 'ini_armature', 0, 180, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('ini_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'ini_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'ini_armature', 181, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'ini_group'], false);
      ...
      setCSSRuleStyle('display', 'none', 'enter_AR_button', false, '');
      changeVis('edit_button', true);
      changeVis(['drag_move', 'drag_rotate', 'drag_scale', 'ready_button', 'scale_percentage'], false);
    }, function() {
      changeVis(['GROUP', 'ini_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('ini_armature', false, 'position', createVector(0, 0, 0), false);
      setCSSRuleStyle('display', 'block', 'enter_AR_button', false, '');
      changeVis(['drag_move', 'drag_rotate', 'drag_scale', 'edit_button', 'scale_percentage', 'ready_button'], false);
      setObjTransform('ini_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('ini_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'ini.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'ini_group'], true);
  changeVis(['GROUP', 'indicator_group'], false);
  setObjTransform('ini_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('ini_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('ini_armature', 'XY', 'WORLD', ',!t`cAthwe;?ZuVfH(ja', 'K%9:`jnxN[?tdo:@i)d|');
}, function() {}, 'K%9:`jnxN[?tdo:@i)d|');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('ini_armature', 'Z', 'WORLD', 'ASbqu{Z.(l.e!QjX6qU+', ':Do`j%pLvZhx[+v.Z;g$');
}, function() {}, ':Do`j%pLvZhx[+v.Z;g$');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('ini_armature', 'Z', 'j71@_NyFG6ougQ[K$76[', '{Xrgi{jq`CGCG_Qd*)LV');
  dragScale('ini_armature', 'X', '90:oM5f=4s-gWh{~3KQ4', '{Xrgi{jq`CGCG_Qd*)LV');
  dragScale('ini_armature', 'Y', 'z*S@+[Y!($!90MoFsIvQ', '{Xrgi{jq`CGCG_Qd*)LV');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('ini_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, '{Xrgi{jq`CGCG_Qd*)LV');
